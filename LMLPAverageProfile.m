...
%%factors (sea level). For each hour of the experiment (of their second phase LMLP)
...
BRE=0;%997160.4;%mm^3/hr %backround erosion rate
...
Zr(q)=Amp*sin(q*B);
Zc=37.5+ Zr(q)  + Z(q); %sea level starts at 37.5 in the LMLP and oscillates 
